  ...
  return (
    <BackContainer>
      ...
      <ColumnContainer>
        ...
        <GreenButton width='300px'>나영이의 유럽 여행기 보러가기</GreenButton>

        <GreenButton width='300px'>Draw My Life 보러가기</GreenButton>

        <TextHeader>나영이의 대학 진로 활동 모음</TextHeader>
        <GreenButton width='300px'>나영이의 깃허브 보러가기</GreenButton>
        ...
        <GreenButton width='300px'>나영이의 개인 공부 보러가기</GreenButton>

        <TextHeader>나영이의 서버 구축 일기</TextHeader>
        <GreenButton width='300px'>개인 물리 서버 만든 날</GreenButton>
        <GreenButton width='300px'>네이버 클라우드 서버 만든 날</GreenButton>
        <GreenButton width='300px'>트랜잭션 오류로 Oracle 포기한 날</GreenButton>
        <GreenButton width='300px'>무서운 AWS 서버</GreenButton>
        ...
        <GreenButton width='300px'>방명록 남기러 가기</GreenButton>
      </ColumnContainer>
      <SizedBox />
    </BackContainer>
  )
